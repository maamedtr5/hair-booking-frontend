  ...
  return (
    <div className="cl-page">
      ...
      <style>{`
        ...
        .cl-detail__tabs { display:flex;gap:.25rem;border-bottom:1px solid var(--color-border,#e5e0d8); }
        ...
        .cl-detail__row { display:flex;justify-content:space-between;padding:.5rem 0;border-bottom:1px solid var(--color-border,#e5e0d8);font-family:var(--font-body,'DM Sans',sans-serif);font-size:.9rem; }
